...
const Footer = () => {
  const socialIcons = [
    ...
    },
    {
      ...
      href: "https://www.instagram.com/mae_the_artist/",
    },
    {
      name: "LinkedIn",
  ...
  
    {
      ...
      href: "mailto:mariamkosemani1@gmail.com",
    },
  ];
    ...
    <footer className="py-16 bg-black text-[#F5EFE7] text-center">
      <div className="px-6 max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          variants={textVariants}
        >
          <p className="my-2 font-bold">Are you a fan of books and historical fiction?  <a href="https://littafi.com/blog/what-is-african-literature/" className="text-blue-700">click here</a></p>
          © 2025 <span className="font-bold">MK</span>
        </motion.p>
      </div>
    </footer>
  );
