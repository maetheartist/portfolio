    ...
    <section className="flex flex-col items-center mt-32 h-auto lg:px-20 lg:h-[100vh] lg:flex-row lg:mt-0 ">
      ...
      >
        ...
        >
          ...
          , a Frontend Developer heavy on Frontend and passionate about pixel-pefect deployments. I develop industry-standard products
        ...
        >
          <motion.a
            href="https://www.linkedin.com/in/mariamkosemani/"
            target="_blank"
          ...
          <motion.a
            href="https://instagram.com/mae_the_artist_"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
      ...
      <motion.div
        className="relative mt-8 lg:mt-0 w-full max-w-xs mx-auto overflow-hidden shadow-xl lg:w-[800px] group border border-[#F5EFE7] rounded p-3 transition-all 1s cursor-pointer"
